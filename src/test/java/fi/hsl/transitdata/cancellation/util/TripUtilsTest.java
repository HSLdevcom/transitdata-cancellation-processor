...
public class TripUtilsTest {
    ...
    public void testFilterTripInfos() {
        ...
        Set<String> outputTripIds = outputTrips.stream().map(InternalMessages.TripInfo::getTripId)
    ...
    public static InternalMessages.TripInfo createTripInfo(String routeId, String gtfsId, String operationDay,
            String startTime, int directionId, boolean generateTripId) {
