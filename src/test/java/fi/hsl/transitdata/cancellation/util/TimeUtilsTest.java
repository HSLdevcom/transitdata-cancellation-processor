...
public class TimeUtilsTest {
    ...
    public void testGetDateAsString() {
        ...
        String expected = LocalDateTime.ofInstant(expectedInstant, ZoneId.of("Europe/Helsinki"))
    ...
    public void testConvertInto30hClockStrings() {
        ...
        AbstractMap.SimpleEntry<String, String> timestamp30h_1550 = TimeUtils
                .convertInto30hClockStrings(localDateTime1550);
        AbstractMap.SimpleEntry<String, String> timestamp30h_0029 = TimeUtils
                .convertInto30hClockStrings(localDateTime0029);
        AbstractMap.SimpleEntry<String, String> timestamp30h_0415 = TimeUtils
                .convertInto30hClockStrings(localDateTime0415);
    ...
    public void testIsBetween() {
        assertTrue(TimeUtils.isBetween("20240129", "2251", new AbstractMap.SimpleEntry<>("20240129", "0800"),
                new AbstractMap.SimpleEntry<>("20240130", "0800")));

        assertFalse(TimeUtils.isBetween("20240129", "0755", new AbstractMap.SimpleEntry<>("20240129", "0800"),
                new AbstractMap.SimpleEntry<>("20240130", "0800")));

        assertTrue(TimeUtils.isBetween("20240129", "2510", new AbstractMap.SimpleEntry<>("20240129", "0800"),
                new AbstractMap.SimpleEntry<>("20240130", "0800")));

        assertFalse(TimeUtils.isBetween("20240129", "2251", new AbstractMap.SimpleEntry<>("20240129", "2600"),
                new AbstractMap.SimpleEntry<>("20240130", "0800")));
    }
}